...
// ========== CO4: Java Collections Framework ==========
// Syllabus Topic: Collections Framework, Collections (List, Queue, Stack, Map)
// This class uses JComboBox which uses internal Collections
...
public class AddEventDialog {
    ...
    public static void openAddEventDialog(JFrame parent) {
        ...
        // Type - Using ArrayList internally via ComboBox (CO4: Collections)
        ...
        saveBtn.addActionListener(e -> {
            try {
                ...
                // This calls EventList.addEvent which:
                // - Adds to Singly Linked List (CO2)
                // - Adds to HashMap for O(1) lookup (CO4)
                // - Adds to ArrayList for efficient iteration (CO4)
                // - Pushes to Undo Stack (CO3)
